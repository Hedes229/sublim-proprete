    ...
    <nav className="glass-nav docked full-width top-0 sticky z-50">
      <div className="flex justify-between items-center w-full px-8 py-4 max-w-7xl mx-auto">
        ...
        <div className="hidden md:flex items-center space-x-8">
          <Link href="/" className="font-inter text-sm font-medium tracking-tight text-slate-600 hover:text-blue-600 transition-colors">Home</Link>
          ...
          <Link href="/about" className="font-inter text-sm font-medium tracking-tight text-slate-600 hover:text-blue-600 transition-colors">About</Link>
